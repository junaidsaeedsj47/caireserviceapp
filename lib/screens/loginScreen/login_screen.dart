          ...
          builder: (contextBuilder, model, child) {
            return ResponsiveWrapper.builder(
                Scaffold(
                  ...
                  backgroundColor:
                      AppColors.instance.beforeLoginScreensBackground,
                  body: Center(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyleUtil
                                        .textStyleBeforeLoginRaqiBook(context,
                                            fontSize: UniversalPlatform.isWeb
                                                ? Constants.webTitleFontSize
                                                : 24),
                                    textAlign: TextAlign.center,
                                  ),
                                  UniversalPlatform.isWeb
                                      ? AppUtils.webTitleSpacing(context)
                                      : SizedBox(
                                          height:
                                              DynamicSize.height(0.02, context),
                                        ),
                                  ...
                                  // ),
                                  UniversalPlatform.isWeb
                                      ? AppUtils.webSpacingBetween(context)
                                      : SizedBox(
...
//                ),
                                  ...
                                  UniversalPlatform.isWeb
                                      ...
                                      : SizedBox(
                                          height:
                                              DynamicSize.height(0.05, context),
                                        ),
                                  Text(
