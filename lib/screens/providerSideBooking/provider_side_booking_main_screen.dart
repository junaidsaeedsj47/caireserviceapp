...
import 'package:caireapp/screens/reschedule_booking/reschedule_booking_screen.dart';
...
class ProviderSideBookingScreen extends StatefulWidget {
  final bool userFromProvider;

  const ProviderSideBookingScreen({
    Key? key,
    this.userFromProvider = false,
  }) : super(key: key);

  @override
  _ProviderSideBookingScreenState createState() =>
      _ProviderSideBookingScreenState();
}
...
class _ProviderSideBookingScreenState extends State<ProviderSideBookingScreen> {
          ...
          builder: (contextBuilder, model, child) {
            return Scaffold(
              ...
              appBar: AppUtils.showAppBar(
                  context: context,
                  title: "Booking",
                  showBack: widget.userFromProvider ? true : false),
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          //     },
                          //     items: model.listOfBookingServices
  ...
  Widget tabBarItems(BuildContext context, ProviderSideBookingViewModel model) {
    return Container(
      margin: const EdgeInsetsDirectional.only(start: 10, end: 10, top: 20),
      height: 40,
      child: ListView.builder(
          scrollDirection: Axis.horizontal,
          itemCount: model.tabBarItems.length,
                ...
                Expanded(
                  child: Container(
                    ...
                    child: CupertinoButton(
                        ...
                        borderRadius: BorderRadius.circular(8),
                        color:
                            AppColors.instance.lightGreyText.withOpacity(0.1),
                        child: Text(
                          'Schedule',
                          style: TextStyleUtil.textStyleRaqiBook(context,
                              color: Colors.black),
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const ProviderSideServiceCompleted(
                                      providerCompletingService: true,
                                    )),
                          );
                        }),
                  ),
  ...
  scheduleNewBooking(BuildContext context) {
    return showDialog(
        context: context,
        builder: (contextBuilder) => ReScheduleBooking(
              title: "Schedule",
